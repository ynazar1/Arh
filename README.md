...
### Compatibility
- Works with retail
- Should work with Cataclysm (and up) Classic, make sure to use [Gathermate2-classic](https://www.curseforge.com/wow/addons/gathermate2-classic) with Cataclysm
- Note: I don't play classic so need to rely on user-reported issues.
